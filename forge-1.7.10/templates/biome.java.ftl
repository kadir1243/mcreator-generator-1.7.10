...
@Elements${JavaModName}.ModElement.Tag public class Biome${name} extends Elements${JavaModName}.ModElement {
	...
	static class BiomeGenCustom extends BiomeGenBase {
		...
		public BiomeGenCustom() {
			...
			theBiomeDecorator.treesPerChunk = ${data.treesPerChunk};
			theBiomeDecorator.flowersPerChunk = ${data.flowersPerChunk};
			theBiomeDecorator.grassPerChunk = ${data.grassPerChunk};
			theBiomeDecorator.mushroomsPerChunk = ${data.mushroomsPerChunk};
			theBiomeDecorator.bigMushroomsPerChunk = ${data.bigMushroomsChunk};
			theBiomeDecorator.reedsPerChunk = ${data.reedsPerChunk};
			theBiomeDecorator.cactiPerChunk = ${data.cactiPerChunk};
			theBiomeDecorator.sandPatchesPerChunk = ${data.sandPatchesPerChunk};
			theBiomeDecorator.gravelPatchesPerChunk = ${data.gravelPatchesPerChunk};
